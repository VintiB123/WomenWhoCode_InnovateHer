      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            style={{
              background:
                "linear-gradient(180deg, var(--tw-color-orange-100), var(--tw-color-teal-200))",
            }}
            key={item.name}
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-sm leading-[1.6] text-orange-900 dark:text-teal-100 font-normal">
                {item.quote}
              </span>
